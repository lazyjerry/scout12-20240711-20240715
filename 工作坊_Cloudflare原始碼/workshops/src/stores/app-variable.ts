...
export function generateVariables() {
	return {
		key:{
			accountSession:"workshop-account-token",
			accountInfo:"workshop-account-info",
			shopKey: "workshop-shopKey",
			shopKeyExpire:"workshop-shopKey-expire",
			searchKey: "workshop-searchKey",
