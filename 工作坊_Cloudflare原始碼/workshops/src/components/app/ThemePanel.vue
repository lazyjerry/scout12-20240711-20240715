...
var themeList = [
 ...
 { name: 'Default', bgClass: 'bg-purple', themeClass: 'theme-purple' },
...
var coverList = [
	{ name: 'Default', coverThumbImage: '/assets/img/cover/cover-thumb-3.jpg', coverClass: 'bg-cover-3'},
	{ name: 'Cover 2', coverThumbImage: '/assets/img/cover/cover-thumb-2.jpg', coverClass: 'bg-cover-2'},
	{ name: 'Cover 3', coverThumbImage: '/assets/img/cover/cover-thumb-1.jpg', coverClass: 'bg-cover-1'},
